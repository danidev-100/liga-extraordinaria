...
export default function StandingsPage() {
  ...
  useEffect(() => {
    getAllLeagues()
      .then((data) => setLeagues(data as LeagueOption[]))
      .catch(console.error)
  }, [])

  // Load categories (filtered by leagueId)
  useEffect(() => {
    getAllCategories(leagueId || undefined)
      .then((data) => {
  ...
  async function handleRecalculate() {
    ...
    try {
      await recalculateStandings(selectedCategoryId)
